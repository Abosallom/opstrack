...
/**
 * THE PRODUCT MARK — the nphies ring, at icon scale.
 *
 * Not decoration and not interchangeable with `IconBolt`, which this replaced in
 * the three brand lockups (SignIn, Claim, Privacy) and which correctly keeps
 * every OTHER call site: a bolt means "quick capture" there, and the two
 * meanings were only ever sharing a glyph by accident.
 *
 * MONOCHROME ON PURPOSE. The full mark is an eight-hue spectrum
 * (`public/icon.svg`, generated by scripts/make-icon.mjs) and it renders in
 * colour wherever it has room — the browser tab, the home screen, the App Store.
 * Here it sits at 16px inside a 28px `--accent` plate and inherits
 * `--accent-ink`, so eight gradients would be eight muddy smudges and the plate
 * would fight them. Shape carries the identity at this size; colour carries it
 * at every larger one.
 *
 * SAME GEOMETRY RULE as the generator, restated for a 24-grid: eight arcs on
 * r=8, and the gap is sized for what SURVIVES `stroke-linecap: round`, which
 * extends every arc by asin((1.8/2)/8) ≈ 6.46° per end. A 22° gap leaves 9.1°
 * visible. Picking the gap by eye is how the first full-size attempt rendered a
 * solid doughnut — see docs/BRAND-NPHIES.md.
 */
export const IconRing = icon(
  <path d="M10.41 4.16A8 8 0 0 1 13.59 4.16M16.42 5.33A8 8 0 0 1 18.67 7.58M19.84 10.41A8 8 0 0 1 19.84 13.59M18.67 16.42A8 8 0 0 1 16.42 18.67M13.59 19.84A8 8 0 0 1 10.41 19.84M7.58 18.67A8 8 0 0 1 5.33 16.42M4.16 13.59A8 8 0 0 1 4.16 10.41M5.33 7.58A8 8 0 0 1 7.58 5.33" />,
)
